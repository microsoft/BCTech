codeunit 50143 SubstituteReportChallenge implements "CTF Challenge"
{
    ...
    var
        HintLine1: Label 'b. Create a ''Hello World '' app  and an ''Snapshot Attach Configuration'' in VSCode (The environment type should be Sandbox)\';
        HintLine2: Label 'c. Be sure you do not have any breakpoints defined in your demo app.\';
        HintLine3: Label 'd. This is important for capturing AL exceptions originating from event subscriptions.\';
