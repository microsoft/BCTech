...
, httpStatusCode = tostring( case( isnotempty(customDimensions.httpStatusCode), customDimensions.httpStatusCode, customDimensions.httpReturnCode ) )
...
, Endpoint, HttpStatusCode, HttpMethod
