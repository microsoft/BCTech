report 52800 "Sales Order"
{
    DefaultRenderingLayout = "Sales Order Layout";
    WordMergeDataItem = SalesOrder;
    ...
    rendering
    {
        layout("Sales Order Layout")
        {
            Type = Word;
            LayoutFile = './Layout/SalesOrder.docx';
            Caption = 'Sales Order Layout';
            Summary = 'Word Layout for Sales Order';
        }
    }
