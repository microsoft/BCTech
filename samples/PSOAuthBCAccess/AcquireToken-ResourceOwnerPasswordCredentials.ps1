...
$AuthenticationResult = Get-MsalToken -ClientId $ClientId -RedirectUri $RedirectUri -TenantId $TenantId -Authority $AuthorityUri -UserCredential $UserCredential -Scopes $BcScopes
