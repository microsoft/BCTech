...
page 50103 "Demo3"
{
    ...
    Caption = 'Demo3 - Weather function';
    DelayedInsert = true;
    ...
    var
        ...
        WeatherFunction: Codeunit "Weather Function";
        Secret: Text;
        LastError: Text;
    ...
    begin
        ...
        AoaiChatMessages.AddTool(WeatherFunction.GetToolPrompt());
        ...
        BigOutput := '<pre>' + AoaiChatMessages.GetLastMessage() + '</pre>';
