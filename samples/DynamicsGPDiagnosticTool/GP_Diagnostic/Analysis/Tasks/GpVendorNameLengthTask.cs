...
/// <summary>
/// A task to determine vendor names with lengths greater than 50 characters.
/// </summary>
public class GpVendorNameLengthTask : IDiagnosticTask
{
    public class Item
    {
    ...
    /// <inheritdoc/>
    public string Description => Resources.GpVendorNameLengthTaskDescription;
    ...
    /// <inheritdoc/>
    public string UniqueIdentifier => "VendorNameLength";

    public GpVendorNameLengthTask(IGpDatabase database)
    {
